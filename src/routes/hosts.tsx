...
function HostsPage() {
  return (
    <div className="pt-[var(--header-height)] text-foreground">
      <Header />
      <section className="container-page py-20 md:py-28 grid md:grid-cols-12 gap-10">
        <div className="md:col-span-7">
          <div className="eyebrow mb-6">For hosts</div>
      ...
      <section className="glass-strong border-y border-[oklch(0.88_0.08_86_/_0.1)]">
        <div className="container-page py-20 text-center">
          <h2 className="font-display text-4xl md:text-5xl">Ready to apply?</h2>
